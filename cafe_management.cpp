...
//**************************Defination of class bill**********************
struct minibill //structure to avoid array of each of these data members in bill
{ 	char nm[20];
	float prc;
	int ino;
	int qty;
...
{	int a,no,c;
	...
	cout<<"4.Search a customer on the basis of customer name";
	cout<<"\n5.Modify record of a customer\n6.Delete record of a customer\n";
...
{ 	ofstream fout;
	...
	for(int o=0; o<n; o++)
		{	cout<<ibill[o].ino<<"\t\t "<<ibill[o].nm<<"\t\t ";
			cout<<ibill[o].prc<<"\t\t"<<ibill[o].qty<<"\t\t\t";
			cout<<ibill[o].qty*ibill[o].prc<<"\n";
		}
